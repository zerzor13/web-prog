...
5.  Модифікуйте свій попередній проект. Для кожної сутності зробіть окрему модель.
6.  Файл конфігурації з налаштуваннями підключення до БД винесіть окремо.
7.  Впевніться, що всі вихідні HTML-сторінки є валідними, використавши валідатор HTML-коду [validator.w3.org](https://validator.w3.org/). За необхідності, виправити помилки та зауваження
8.  Для проекту створіть папку "lab 13" в своєму репозиторії "web-progr" на Github. Завантажте кінцеві файли лабораторної роботи. 
