...
У разі виникнення помилки під час міграції можна виконати відкат за допомогою команди:
...
5.  Заповніть міграції потрібними даними. 
6.  Впевніться, що необхадні таблиці створені, шляхом перегляду бази даних через phpMyAdmin.
7.  Вивантажте проект на Github.
8.  Для кожного етапу роботи зробіть знімки екрану та додайте їх у звіт з описом кожного скіншота.
9.  Дайте відповіді на контрольні запитання
10. Додайте в кінці звіту посилання на репозиторій з лабораторною роботою
