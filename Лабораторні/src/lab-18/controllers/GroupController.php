...
class GroupController extends Controller
{
    public function index()
    {
        ...
        echo '<a href="index.php?action=groups&subaction=create">Додати групу</a>';
        echo "<table border='1'>";
    ...
    public function create()
    {
        ...
        <form action="index.php?action=groups&subaction=store" method="post">
            <div>
    ...
    public function store()
    {
        ...
        echo '<a href="/index.php?action=groups">До переліку груп</a>';
    }
}