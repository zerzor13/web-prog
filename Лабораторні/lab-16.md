...
## Контрольні питання
1. Що таке модель в архітектурі MVC (Model-View-Controller)?
2. Як моделі взаємодіють із базою даних у веб-розробці?
3. Чому важливо використовувати моделі для роботи з даними, а не безпосередньо вбудовані запити до бази даних?
4. Як можна визначити та викликати методи моделі для обробки даних?
5. Як в моделях обробляються операції створення, оновлення та видалення записів в базі даних?
6. Як в моделях вирішуються проблеми з безпекою та попередженням атак типу SQL Injection?
7. Чому важливо визначати логіку бізнес-правил в моделях, а не у контролерах чи виду?
